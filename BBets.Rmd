...
mean(Substitute)
```
The average earnings, if 40 Brownlows were hired to play the game the exact same way, would be about $286.9.
...
By creating these copycat Brownlows, and gathering data on the mean and standard deviation of their samples, we were able to find a reasonable interval centered at the fairest odds ("fair odds" imply the profit is zero).  The "fair odd" value was found to be 4.38, meaning that, if Brownlow were to wager $4.38 for every $1 given, there would be a profit of essentially zero.
